...
set COCOS2DX_ROOT=%QUICK_COCOS2D_MINI%\lib\cocos2d-x
...
"%ANDROID_NDK_ROOT%\ndk-build" -j4 %ANDROID_NDK_BUILD_FLAGS% NDK_DEBUG=%NDK_DEBUG% %NDK_BUILD_FLAGS% -C %APP_ANDROID_ROOT% NDK_MODULE_PATH=%QUICK_COCOS2D_MINI%;%COCOS2DX_ROOT%;%COCOS2DX_ROOT%\cocos2dx\platform\third_party\android\prebuilt
