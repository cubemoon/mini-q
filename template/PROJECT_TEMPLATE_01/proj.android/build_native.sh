...
COCOS2DX_ROOT=$QUICK_COCOS2D_MINI/lib/cocos2d-x
...
"NDK_MODULE_PATH=${QUICK_COCOS2D_MINI}:${COCOS2DX_ROOT}:${COCOS2DX_ROOT}/cocos2dx/platform/third_party/android/prebuilt"
